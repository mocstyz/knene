...
export const MOVIE_ENDPOINTS = {
  ...
  MOVIES_BY_CATEGORY: (categoryId: string) => `/movies/categories/${categoryId}`,
  ...
  UPDATE_RATING: (movieId: string, ratingId: string) => `/movies/${movieId}/ratings/${ratingId}`,
  
  // 影片评论
  COMMENTS: (movieId: string) => `/movies/${movieId}/comments`,
  ADD_COMMENT: (movieId: string) => `/movies/${movieId}/comments`,
  UPDATE_COMMENT: (movieId: string, commentId: string) => `/movies/${movieId}/comments/${commentId}`,
  DELETE_COMMENT: (movieId: string, commentId: string) => `/movies/${movieId}/comments/${commentId}`,
...
export const ADMIN_ENDPOINTS = {
  ...
  UPLOAD_STATUS: (batchId: string) => `/admin/movies/bulk-upload/${batchId}/status`,
